...
function userMoviesApi (app) {
  ...
  router.get('/', validationHandler(joi.object({ userId: userIdSchema }), 'query'), async (req, res, next) => {
  ...
  router.delete('/:userMovieId', validationHandler(joi.object({ userMovieId: userMovieIdSchema }), 'params'), async (req, res, next) => {
